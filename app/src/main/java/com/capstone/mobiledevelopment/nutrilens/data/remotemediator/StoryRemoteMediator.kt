package com.capstone.mobiledevelopment.nutrilens.data.remotemediator
...
import com.capstone.mobiledevelopment.nutrilens.data.database.remotekey.RemoteKeys
import com.capstone.mobiledevelopment.nutrilens.data.database.story.StoryEntity
...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        try {
            val response = apiService.getAllStories(token, page, state.config.pageSize, 0)
            ...
            database.withTransaction {
                ...
                val storyEntities = stories.map {
                    StoryEntity(
                        ...
                        lon = it?.lon ?: 0.0, // Default value for lon
                        lat = it?.lat ?: 0.0  // Default value for lat
                    )
                }
